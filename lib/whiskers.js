...
(function(whiskers) {
  ...
  whiskers.compile = function(template) {
    ...
    // c is context, g is get, o is object, k is key, p is properties, b is buffer
    return new Function('c', 'var g=function(o,k){var p=k.split(\'.\');for(var i=0,l=p.length;i<l;i++){o=o[p[i]];if(!o)break}if(typeof o==\'function\')o=o();return o||\'\'};var b=\''+template+'\';return b');
  };
