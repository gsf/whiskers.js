...
(function(whiskers) {
  ...
  whiskers.compile = function(template) {
    ...
    template = template.replace(/(\n[ \t]*|)(\\*){![\s\S]*?!}(?:([ \t]*(?=\n))|)/g, function(str, newlineBefore, escapeChar, newlineAfter) {
      if (escapeChar) return str.replace('\\\\', '');
    ...
    return new Function('c', 'var g=function(k){var v;try{v=eval(\'c.\'+k)||\'\'}catch(e){v=\'\'}if(typeof v==\'function\')v=v(c);return v;};var b=\''+template+'\';return b');
  };
