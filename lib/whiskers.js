...
whiskers.compile = function(template) {
  ...
  return '(function(){return function(c){var v=function(o,k){var r=function(o,s){if(s.length===0){if(typeof o===\'function\')return o();return o}var f=s.shift();if(!o.hasOwnProperty(f))return \'\';return r(o[f],s)};var s=k.split(\'.\');return r(o,s)};var b=\''+template+'\';return b}})()';
};
